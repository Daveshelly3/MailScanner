          ...
          <div className="rounded-2xl border border-white/10 bg-white/5 p-8 shadow-2xl backdrop-blur-sm">
            <div className="text-center">
              ...
              <p className="mt-2 text-slate-300">
                AI-powered email triage for client-facing teams. Scan your Outlook inbox and surface what needs a response — in seconds.
              </p>
            </div>
            ...
            <div className="mt-6 flex items-start gap-2 text-xs text-slate-400">
              ...
              <span>Read-only access — MailScanner never sends, modifies, or stores your emails. Your content is processed in-memory only.</span>
            </div>
          </div>

          <div className="mt-8 grid grid-cols-3 gap-4 text-center">
            {[
              { label: 'Detection recall', value: '≥ 90%' },
              { label: 'Scan time (50 emails)', value: '< 30s' },
              { label: 'False positive rate', value: '< 15%' },
            ].map(({ label, value }) => (
